...
function RootNavigation({ splashFinished }: { splashFinished: boolean }) {
  ...
  const inProtectedDetail = ["discover-campaigns", "campaign", "card", "notifications"].includes(segments[0] || "");
  ...
  }, [inAuthGroup, inProtectedDetail, inTabsGroup, loading, rootNavigationState?.key, router, splashFinished, user]);
