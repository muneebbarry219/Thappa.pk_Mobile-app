...
interface CardDetail { _id: string; currentStamps: number; stampsRequired: number; businessId: { name: string; category: string }; branchId: { name: string; address?: string }; campaignId?: { headline: string } | null; }
